...
import langLogo from "../../assets/langchain.svg";
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				>
					<h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
						Seamless{" "}
						<span className="text-[#ffc300]">Framework Integration</span>
					</h2>
				...
				<div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
					<motion.div
						...
						viewport={{ once: true }}
					>
						<div className="relative bg-[#1b012f] from-gray-800 to-gray-900 rounded-2xl shadow-2xl p-8 border border-gray-700">
					...
					<motion.div
						...
						viewport={{ once: true }}
					>
						<Card className="bg-[#1b012f] rounded-2xl">
							<CardContent className="p-8">
								<div className="flex items-center space-x-4 mb-4">
									<div className="w-12 h-12 bg-orange-500 rounded-xl flex items-center justify-center">
										<Image src={eliza} alt="Eliza" />
									</div>
								...
								<div className="flex items-center text-orange-500 font-medium">
									<CheckCircle
										color="black"
										className="w-5 h-5 mr-2 bg-[#ffc300] rounded-full"
									/>
									<span className="text-[#ffc300]">Production Ready</span>
								</div>
							</CardContent>
						</Card>

						<Card className="bg-[#1b012f] rounded-2xl border border-blue-100">
							<CardContent className="p-8">
								<div className="flex items-center space-x-4 mb-4">
									<div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center">
										{/* <Image src={langLogo} alt="langchain" /> */}
										<svg
											fill="currentColor"
											fill-rule="evenodd"
											height="2em"
								...
								<div className="flex items-center text-blue-600 font-medium">
									<CheckCircle
										color="black"
										className="bg-[#ffc300] w-5 h-5 mr-2 rounded-full"
									/>
									<span className="text-[#ffc300]">Fully Compatible</span>
								</div>
							</CardContent>
						</Card>
					</motion.div>
