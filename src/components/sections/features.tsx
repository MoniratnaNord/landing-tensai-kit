			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				>
					<h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
						...
						<span className="text-[#ffc300]"> Tensai Kit</span>
					</h2>
					<p className="text-xl text-gray-600 max-w-3xl mx-auto">
						TensaiKit provides everything you need to build, deploy, and scale
						autonomous AI agents for DeFi operations on Katana Network.
					</p>
				</motion.div>
						...
						>
							<Card className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 h-full">
								<CardContent className="p-8">
									<div
										className={`w-16 h-16 m-auto bg-[#ffc300] rounded-2xl flex items-center justify-center  mb-6`}
									>
