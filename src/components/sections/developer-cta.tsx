...
export default function DeveloperCTA() {
  return (
    <section id="developers" className="py-20 bg-gradient-to-br from-orange-50 via-red-50 to-yellow-50">
                ...
                >
                  <div className="bg-gray-800 rounded-xl p-6 font-mono text-sm">
                    <div className="flex items-center space-x-2 mb-4">
                      ...
                      <span className="text-gray-400 ml-4">tensai-agent.js</span>
                    </div>
                    <div className="space-y-2 text-green-400">
                      ...
                      <div className="ml-4">
                        <span className="text-red-400">protocols</span>: [
                        <span className="text-yellow-400">'morpho'</span>,{' '}
                        <span className="text-yellow-400">'sushi'</span>],
                      </div>
                      <div className="ml-4">
                        <span className="text-red-400">strategy</span>:{' '}
                        <span className="text-yellow-400">'yield-optimization'</span>
                      </div>
                      <div>{'});'}</div>
